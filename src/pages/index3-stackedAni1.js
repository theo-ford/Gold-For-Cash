...
import { AnimationStacked1 } from "../components/tf/animation-stacked-1";
...
const BackgroundCon = styled.div`
  ...
  overflow: hidden;
`;
const BackgroundAniCon1 = styled.div`
  height: 100vh;
  width: 100vw;
  ...
  display: block;
`;
const BackgroundAniCon2 = styled.div`
  height: 100vh;
  width: 100vw;
  background-color: green;
  position: relative;
...
const Index = ({ data }) => {
  ...
  const PageContentConRef = useRef(null);
  const BackgroundConRef = useRef(null);

  const [pageContentHeightState, setPageContentHeightState] = useState(null);
  const [backgroundHeightState, setBackgrounHeightState] = useState(null);

  // const [
  //   pageContentTallerThanBackground,
  //   setPageContentTallerThanBackground,
  // ] = useState(null);

  useEffect(() => {
    // console.log(
    //   "Page Content Con Height",
    //   PageContentConRef.current ? PageContentConRef.current.offsetHeight : 0
    // );
    // console.log(
    //   "Background Con Height",
    //   BackgroundConRef.current ? BackgroundConRef.current.offsetHeight : 0
    // );

    var BackgroundConHeight = BackgroundConRef.current
      ? BackgroundConRef.current.offsetHeight
      : 0;
    var PageContentConHeight = PageContentConRef.current
      ? PageContentConRef.current.offsetHeight
      : 0;

    setPageContentHeightState(PageContentConHeight);
    setBackgrounHeightState(BackgroundConHeight);
  }, [
    PageContentConRef.current,
    BackgroundConRef.current,
    setBackgrounHeightState,
    setPageContentHeightState,
  ]);

  console.log(pageContentHeightState);
  console.log(backgroundHeightState);

  // useEffect(() => {
  //   if (pageContentHeightState > backgroundHeightState) {
  //     setPageContentTallerThanBackground(true);
  //   }
  // }, [
  //   pageContentHeightState,
  //   backgroundHeightState,
  //   setPageContentTallerThanBackground,
  // ]);

  // console.log(pageContentTallerThanBackground);

  // function printBackground() {
  //   return (
  //     <>
  //       <BackgroundAniCon1></BackgroundAniCon1>
  //       <BackgroundAniCon2></BackgroundAniCon2>
  //     </>
  //   );
  //   // if (pageContentTallerThanBackground) {

  //   // }
  // }
  // function printBackground2() {
  //   while (pageContentHeightState > backgroundHeightState) {
  //     printBackground();
  //   }
  // }
  ...
  return (
    <>
      <PageContentCon ref={PageContentConRef}>
        <HeroCon>
          {isPageWide ? (
            <SizzleVidConCon>
              <Grid16>
      ...
      <BackgroundCon
        ref={BackgroundConRef}
        style={{ height: pageContentHeightState }}
      >
        <AnimationStacked1></AnimationStacked1>
        <AnimationStacked1></AnimationStacked1>
        <AnimationStacked1></AnimationStacked1>
        <AnimationStacked1></AnimationStacked1>
        <AnimationStacked1></AnimationStacked1>
